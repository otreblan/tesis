...
\begin{enumerate}
    \item Tener un conjunto de datos de documentos para el entrenamiento del modelo.
...
Trabajaremos principalmente con documentos escaneados con texto manuscrito y tipeado.
